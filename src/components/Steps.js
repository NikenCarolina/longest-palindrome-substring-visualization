...
export function Steps({ value, stepMatrices }) {
  ...
  const answer_style_header = {
    position: "sticky",
    left: 0,
    backdropFilter: "blur(10px)",
  };

  return Object.entries(stepMatrices["step"]).map(
    ([mainKey, mainObject], index) => {
      return (
        <div
          key={mainKey + "[" + index + "]"}
        ...
        >
          <div className="step-title">
            ...
            <a
              href={"#" + stepToAnchor("step-" + index)[0]}
            ...
            <a
              href={"#" + stepToAnchor("step-" + index)[1]}
              ...
              <div key={matricesIndex} className="step-container">
                {substepObject.hasOwnProperty("matrices") && (
                  <div className="step-matrix">
                    ...
                    <DPTable
                      dp={substepObject["matrices"]}
                      string={value}
                      cellUpdated={substepObject["valueUpdated"]}
                    />
                  </div>
                )}
                    ...
                    <table>
                      <tbody>
                        <tr>
                          ...
                          {value
                            .slice(
                              substepObject["answer"][0],
                              substepObject["answer"][1] + 1
                            )
                            .split("")
                            .map((char, charIndex) => {
                              return (
                                <td key={char + charIndex}>
                                  ...
                                  <h4 style={answer_style}>
                                    {substepObject["answer"][0] + charIndex}
                                  </h4>
                                </td>
                              );
                            })}
